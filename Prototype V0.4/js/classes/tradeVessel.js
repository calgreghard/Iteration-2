class tradeVessel {
    ...
    newRoute(city) {
        ...
        if (!this.onReturn)
            this.cargoValue = Math.round(this.route.HOME.properties[this.route.HOME.selectedProduct[this.route.HOME.selectedVessel]].produce.value * this.route.DESTINATION.multiplier);
    }
